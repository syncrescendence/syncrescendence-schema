# Exocortex Teleology Registry — CC90

**Date**: 2026-03-05  
**Status**: active  
**Class**: canonical teleology contract

## Purpose

Extend teleology coverage from the earlier CC80 candidate subset to the full CC90 exocortex inventory.
...
1. Repo remains constitutional authority.
2. Exocortex surfaces execute, relay, and synthesize; they do not ratify policy.
3. Direction-changing outputs must land as repo artifacts.
4. Auth dependency children (`supabase_surface`, `incident_surface`) remain subordinate to parent identity roots.
...
2. ontology unification runbook:
